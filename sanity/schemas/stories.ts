// Story schema for Sanity Studio
// For the 3-column stories section on the homepage
// Same structure as editorials but separate content type
          ...
          marks: {
            ...
            annotations: [
              ...
              },
              {
                ...
                title: "Internal Link",
                fields: [
                  { name: "reference", type: "reference", to: [{ type: "stories" }] },
                ],
              },
              {
                name: "footnote",
