// Editorial schema for Sanity Studio
// Comprehensive schema for editorial content with modular content blocks
// See SCHEMA_DOCUMENTATION.md for full documentation
//
// Content blocks are registered in ./objects/ and referenced by type name:
// - attributedQuote, twoColumnGrid, imageGrid, positionedText
// - fullWidthImage, videoEmbed, accordion, interview
// - numberedGallery, authorBio, creditsBlock, spacer
// - bilingualText, callout, pullQuote, productFeature, imageWithCaption
          ...
          marks: {
            ...
            annotations: [
              ...
              },
              {
                ...
                title: "Internal Link",
                fields: [
                  { name: "reference", type: "reference", to: [{ type: "editorials" }] },
                ],
              },
              {
                name: "footnote",
