  ...
  return (
    <section className="w-full px-6 md:px-12 lg:px-24 py-12 space-y-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Link href="https://www.businessoffashion.com/articles/luxury/chinas-homegrown-jewellery-superstar/" className="block">
          <div className="w-full">
            <div className="w-full h-[400px] relative mb-4">
              <Image
                src="/images/laopu_gold_store_interior.png"
                alt="Laopu Gold: China's Cartier News Article"
                layout="fill"
                objectFit="cover"
                className="rounded-md"
              />
            ...
            <div className="text-left">
              <h3 className="text-lg font-semibold mb-2">Laopu Gold: China’s Homegrown Jewellery Success Story</h3>
        ...
        <Link href="https://www.bbc.com/news/articles/cy4ydxlm9n9o" className="block">
          <div className="w-full">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-600">June 19, 2025</p>
            </div>
          </div>
        </Link>
      </div>
