      ...
      {isOpen ? (
        <form action={formAction}>
          <div className="pb-8">
            ...
            <SubmitButton className="mt-6 uppercase" data-testid="submit-address-button">
        ...
        <div>
          <div className="text-small-regular">
            {cart && cart.shipping_address ? (
              <div className="flex flex-col md:flex-row items-start gap-y-4 md:gap-x-8">
                <div className="flex flex-col md:flex-row items-start gap-y-4 md:gap-x-1 w-full">
                  <div
