...
const BrandCategoryTemplate = ({
  ...
  return (
    <div className="py-6" data-testid="brand-category-container">
              ...
              <div className="mb-8">
                ...
                {(brand.blurb || category.metadata?.intro_blurb) ? (
                  <div className="mt-4 text-base-regular text-gray-600">
                    {brand.blurb && <div className="mb-2">{brand.blurb}</div>}
                    {category.metadata?.intro_blurb && typeof category.metadata.intro_blurb === 'string' ? (
                      <div>{category.metadata.intro_blurb}</div>
                    ) : null}
                  </div>
                ) : null}
              </div>
