  ...
  return (
    <div className="flex flex-col gap-y-6" data-testid="order-details-container">
      ...
      <div className="flex flex-col gap-y-4 border-b border-gray-200 pb-4">
        ...
        <div className="mt-2 grid grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-3 md:gap-8 text-xs sm:text-sm">
          <div className="space-y-1">
      ...
      <div className="flex flex-col gap-y-4 border-b border-gray-200 pb-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <p className="text-xs tracking-[0.15em] uppercase text-gray-700">
            Fulfillment: <span className="text-gray-900">{orderStatus}</span>
          </p>
          <LocalizedClientLink
            href="#"
      ...
      <div className="flex flex-col gap-y-4 pt-2">
        <div className="bg-gray-50 border border-gray-200 px-4 py-5 sm:px-6 sm:py-6">
          <OrderSummary order={order} />
        </div>

        <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mt-2">
          <LocalizedClientLink href="/" className="flex-1 sm:flex-none sm:min-w-[220px]">
            <button className="w-full px-6 py-3 border border-gray-900 text-gray-900 text-xs sm:text-sm font-medium tracking-[0.15em] uppercase hover:bg-gray-900 hover:text-white transition-colors">
              Continue Shopping
            </button>
          </LocalizedClientLink>

          <LocalizedClientLink href="/account/orders" className="flex-1 sm:flex-none sm:min-w-[220px]">
