        ...
        <div className="prose prose-gray max-w-none text-sm">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
              ...
              <li><strong>Payment Information:</strong> Payment details required to process your order (handled securely by our payment processor, PayPal) – we do not see or store full credit card numbers. (PayPal encrypts and tokenizes your payment info in a PCI-compliant manner, so we only receive confirmation that payment was made.)</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
              <li><strong>Payment Processors:</strong> When you pay by credit card, your payment details are securely sent to PayPal, our payment processor. PayPal is a trusted third party that handles payment transactions in compliance with financial regulations. We only receive confirmation of payment and do not see your full credit card number. PayPal uses industry-standard encryption, so your payment data is fully protected.</li>
            ...
            <br></br>
            <p className="text-gray-600 mb-4">
              Any other disclosures of your data are subject to your explicit consent. All disclosures and transfers are done under legal safeguards. In compliance with GDPR, this policy identifies the categories of recipients of personal data. We do not share data with unrelated third parties for cross-marketing. Furthermore, any transfer of data outside your country (for example, to PayPal or Google in the U.S.) is protected by appropriate safeguards such as standard contractual clauses or adequacy decisions as required by law.
            </p>
          </section>
