...
import { isSaleEnabledFromServerSearchParams } from "@lib/util/sale-query"
...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  const description = `Shop the latest fashion for ${genderDisplay} at REVETIR. Premium brands, curated collections, and free shipping.`
...
export default async function GenderPage(props: Props) {
  ...
  const saleOnly = isSaleEnabledFromServerSearchParams(
